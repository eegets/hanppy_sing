...
import 'package:happy_sing/pages/admin/AdminPageContent.dart';
 ...
 * 管理首页
 */
class AdaminPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _AdaminPageState();
}

class _AdaminPageState extends State<AdaminPage> {
  @override
  void initState() {
